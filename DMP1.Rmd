...
```{r Plot, echo=TRUE}
plot(faithful, main = "Do I wait longer for Old Faithful eruptions?")
```
...
Information System software package used by the stakeholders. 
- Naming conventions will be consistent – no spaces will be used in table names
